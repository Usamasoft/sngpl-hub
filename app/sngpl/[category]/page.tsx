...
const categoryFaqs: Record<Category, { q: string; a: string }[]> = {
  'bill-check': [
    { q: 'How do I check my SNGPL bill online?', a: 'Go to billchecker.sngpl.com.pk or use the SNGPL Consumer app. Enter your 10-13 digit consumer number and click Search. Your current bill, consumption, amount due, and due date will display immediately.' },
  ...
  'duplicate-bill': [
    ...
    { q: 'How do I download the duplicate bill as PDF?', a: 'Visit billchecker.sngpl.com.pk, enter your consumer number, view the bill, and click the Download/PDF button on the results page. The PDF downloads to your device automatically.' },
